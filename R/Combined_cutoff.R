...
Combined_cutoff <- function(data, SD.cutoff, SD.condition, TPI.cutoff, TPI.condition, Combined.logic, ttc.colnames, number.items, mandatory.response, item.colnames, ID.colname){
